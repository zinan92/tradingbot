...
const asyncMessage = (ffi, interactionPtr, pactPtr, messageCount, index) => ({
    ...
    getRequestContents: () => ffi.pactffiGetAsyncMessageRequestContents(pactPtr, messageCount, index),
});
    ...
    return {
        ...
        newSynchronousMessage: (description) => {
            ...
            return {
                ...
                withMetadata: (name, value) => ffi.pactffiMessageWithMetadata(interactionPtr, name, value),
                getRequestContents: () => ffi.pactffiGetSyncMessageRequestContents(pactPtr, messageCount, index),
                getResponseContents: () => ffi.pactffiGetSyncMessageResponseContents(pactPtr, messageCount, index),
            };
        },
