"""
Results Formatter for Backtesting

Formats backtest results to match the exact output shown in the screenshots.
Provides both tabular statistics and chart generation.
"""
